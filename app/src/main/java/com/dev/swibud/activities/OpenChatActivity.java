...
import com.dev.swibud.utils.PhotoViewerActivity;
import com.dev.swibud.utils.PreferenceUtils;
import com.dev.swibud.utils.TextUtils;
import com.dev.swibud.utils.UrlPreviewInfo;
import com.dev.swibud.utils.WebUtils;
...
import com.dev.swibud.adapters.ChatAdapter;
...
public class OpenChatActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "OPENCHATACTIVITY";
...
//        setTitle("Meet Up");
    ...
    public void onResume() {
        ...
        mChatAdapter.setContext(OpenChatActivity.this); // Glide bug fix (java.lang.IllegalArgumentException: You cannot start a load for a destroyed activity)
        ...
        if (SendBird.getConnectionState() == SendBird.ConnectionState.OPEN) {
            ...
            if (SendBird.reconnect()) {
                ...
                String userId = PreferenceUtils.getUserId(OpenChatActivity.this);
                if (userId == null) {
                    Toast.makeText(OpenChatActivity.this, "Require user ID to connect to SendBird.", Toast.LENGTH_LONG).show();
                    return;
                }
...
//                mMessageSendButton.setText("SAVE");
    ...
    private void requestMedia() {
        if (ContextCompat.checkSelfPermission(OpenChatActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
    ...
    private void requestStoragePermissions() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OpenChatActivity.this,
    ...
    private void onFileMessageClicked(FileMessage message) {
        ...
        if (type.startsWith("image")) {
            Intent i = new Intent(OpenChatActivity.this, PhotoViewerActivity.class);
            i.putExtra("url", message.getUrl());
            i.putExtra("type", message.getType());
            startActivity(i);
        } else if (type.startsWith("video")) {
            Intent intent = new Intent(OpenChatActivity.this, MediaPlayerActivity.class);
    ...
    private void sendFileWithThumbnail(Uri uri) {
        ...
        if (info == null) {
            Toast.makeText(OpenChatActivity.this, "Extracting file information failed.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (rec !=null){
                if (mChannelUrl.equalsIgnoreCase(rec.getString(Constants.EXTRA_NEW_CHANNEL_URL))){
                    mChatAdapter.load(mChannelUrl);
